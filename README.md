# Learn Data Science by Python Programmer
Source: [Can you LEARN DATA SCIENCE for FREE? YES! I'll show you HOW!](https://www.youtube.com/watch?v=eTxyviU0Ddo) by [Python Programmer](https://www.youtube.com/channel/UC68KSmHePPePCjW4v57VPQg) on YouTube.
...
[Pandas Tutorial](https://pandas.pydata.org/pandas-docs/stable/getting_started/10min.html) | [Pandas Python Data Analysis Library](https://pandas.pydata.org/) |
[Python for Data Analysis, 2nd Edition](https://github.com/wesm/pydata-book) | [Wes McKinney](https://github.com/wesm) | Here are some excellent pandas code examples 
...
[An Intuitive Guide to Linear Algebra](https://betterexplained.com/articles/linear-algebra-guide/) | [BetterExplained](https://betterexplained.com/)
[Introduction to Methods of Applied Mathematics or Advanced Mathematical Methods for Scientists and Engineers](http://physics.bgu.ac.il/~gedalin/Teaching/Mater/am.pdf) | Sean Mauch, [Caltech Information Management Systems & Services](https://www.imss.caltech.edu/), [Caltech](https://www.caltech.edu/)
[Mathematical Tools for Physics](http://www.physics.miami.edu/~nearing/mathmethods/mathematical_methods-one.pdf) | James Nearing, [Physics Department](https://physics.as.miami.edu/index.html), [University of Miami](https://welcome.miami.edu/)
...
[Calculus 2](https://www.khanacademy.org/math/calculus-2) | [Khan Academy](https://www.khanacademy.org/)
[Multivariable Calculus](https://www.khanacademy.org/math/multivariable-calculus) | [Khan Academy](https://www.khanacademy.org/)
...
[Learning Scientific Programming with Python](https://scipython.com/book/) | [Scipython](https://scipython.com/) | Work through as many of the examples as you fancy in Chapters 6 and 7
...
[Applied Statistics](https://bookboon.com/en/applied-statistics-ebook) | Mohammed A. Shayib, [Bookboon](https://bookboon.com/)
[The Only Probability Cheatsheet You'll Ever Need](http://www.wzchen.com/probability-cheatsheet/) | [William Chen](http://www.wzchen.com/)
...
[The Elements of Statistical Learning: Data Mining, Inference, and Prediction. Second Edition](https://web.stanford.edu/~hastie/ElemStatLearn/) | [Trevor Hastie](http://www-stat.stanford.edu/~hastie/), [Robert Tibshirani](http://statweb.stanford.edu/~tibs/) and [Jerome Friedman](http://statweb.stanford.edu/~jhf/), [Stanford University](https://www.stanford.edu/) | Extremely useful
...
Reference | By
:-- | :--:
[Fundamentals Of Linear Algebra](https://www.math.ubc.ca/~carrell/NB.pdf) | James B. Carrell, [Mathematics Department](https://www.math.ubc.ca/), [The University of British Columbia](https://www.ubc.ca/)
[The Python Tutorial](https://docs.python.org/3/tutorial/index.html) | [Python Software Foundation](https://www.python.org/)
[reddit/r/Python](https://www.reddit.com/r/Python/) | [reddit](https://www.reddit.com)
[reddit/r/datascience](https://www.reddit.com/r/datascience/) | [reddit](https://www.reddit.com)
[Questions tagged [python]](https://stackoverflow.com/questions/tagged/python) | [Stack Overflow](https://stackoverflow.com/)
[Stack Exchange: Data Science](https://datascience.stackexchange.com/) | [Stack Exchange](https://stackexchange.com/)
[Project Jupyter](https://jupyter.org/) | [Project Jupyter](https://jupyter.org/)
[How to Think Like a Computer Scientist: Learning with Python 3](http://www.openbookproject.net/thinkcs/python/english3e/) | Peter Wentworth, Jeffrey Elkner, Allen B. Downey, and Chris Meyers, [Open Book Project](http://www.openbookproject.net/)


[WRITE A BLOG](https://onextrapixel.com/start-jekyll-blog-github-pages-free/)

[SLACK GROUPS](https://kagglenoobs.herokuapp.com/)
